...
namespace Emgu.CV
{
   ...
   public class EigenObjectRecognizer
   {
      ...
      {
         Debug.Assert(images.Length == labels.Length, "Fotoðraflarýn Sayisi Kiþilerin Sayýsýna Eþit Olmalý.");
         Debug.Assert(eigenDistanceThreshold >= 0.0, "Mesafe eþiði'nin büyüklüðü>= 0.0 olmalý." );
